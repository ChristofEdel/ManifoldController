...
XTENSA_DIR = PACKAGE_DIR + "/toolchain-xtensa-esp32s3/xtensa-esp32s3-elf"
ESPIDF_DIR = PACKAGE_DIR + "/framework-espidf@3.40407.240606/components"
...
def normalisePath(p: str) -> str:
    ...
    p = re.sub(re.escape(ESPIDF_DIR), "esp-idf:", p, flags=re.IGNORECASE)
